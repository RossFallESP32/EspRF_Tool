...
- Set the <span style="color:red">red Chip Type</spn>, <font color="red">COM Port red</font>, and "Baud Rate</font>. Then, click Open to <font color="red">open</font> the serial port;
