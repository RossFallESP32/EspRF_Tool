...
- Set the <span style="color:red">Chip Type</spn>, <font color="red">COM Port</font>, and "Baud Rate</font>. Then, click Open to <font color="red">open</font> the serial port;
